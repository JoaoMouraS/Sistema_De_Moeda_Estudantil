...
@Component({
  ...
  styles: [`
    ...
    .btn--sm { font-size: var(--text-sm); padding: var(--space-2) var(--space-4); min-height: 34px; }
    .btn--md { font-size: var(--text-base); padding: var(--space-3) var(--space-5); min-height: 42px; }
    .btn--lg { font-size: var(--text-lg); padding: var(--space-4) var(--space-6); min-height: 50px; }
    ...
    .btn--secondary:hover:not(:disabled) { background: var(--color-surface-alt); border-color: var(--color-text-muted); }
    ...
    .btn--ghost:hover:not(:disabled) { background: var(--color-brand-soft); }
    ...
    .btn__content--loading { visibility: hidden; }
    .btn__spinner {
      position: absolute;
